...
both_events = python_set.intersection(java_set)
...
only_one_event = python_set.symmetric_difference(java_set)
...
all_java_in_python = java_set.issubset(python_set)
...
unique_participants = python_set.union(java_set)
